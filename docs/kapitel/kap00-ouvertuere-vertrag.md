# Ouvertüre — Inhaltlicher Vertrag (Vor-Kapitel)
...
**Disziplin der Ouvertüre:** Sie *stellt* die Fragen und *beantwortet keine*. Sie entzündet das
Feuer, stellt die Leitfragen in den Raum, entlässt den Leser ins Buch.

**Keine Leseprobe:** integrale Ouvertüre, nicht überspringbares Vorgeplänkel — das Stück, in dem
die Leitfragen wirklich *entstehen*. Wer es überspringt, versteht das Buch nicht.

---

## Bestandteile

### 1. Das Bild (die Szene)

Die Ngurinderi-Szene an den unteren Seen (dokumentierte Ngarrindjeri-Überlieferung): das Feuer,
die Familien, der Alte, der erzählt — und das Entscheidende, das *um* ihn herum geschieht: die
alte Frau, die die Lippen zu den Worten bewegt, ehe sie fallen; die Kinder, die seiner Hand mit
den Augen folgen. Ein geteiltes Gemeintes, gemeinsam *aktualisiert* — das Abwesende (Ahnen,
zwei Frauen in den Felsen, der Weg der Toten) lebendig gehalten allein durchs gemeinsame
Für-wirklich-Halten.

*Funktion:* atmosphärisch, immersiv, kein Argument. Sie zeigt, was das Buch erklären wird.

### 2. Die Autoren-Wende

Der Autor tritt nach der Szene hervor und sagt, was er vorhat:

- **Universalisieren, dann beiseitelegen:** Solche Erzählungen gibt es in vielen Kulturen, gut
  dokumentiert (Mythos als „soziale Urkunde", Malinowski; weltstiftende heilige Geschichte,
  Eliade; später differenziert, Lévi-Strauss). [Namen zu bestätigen] Aber das Buch interessiert
  sich *nicht* für Gründungsmythen als Gattung.
...
Ein Satz, der das Feuer als Leitbild setzt und ankündigt, dass es wiederkommt — sodass Kapitel
11 und 13 es ernten können.
