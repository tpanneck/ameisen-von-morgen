# Glossar — die tragenden Begriffe

*Das kontrollierte Vokabular des Buches. Es ist die Antwort auf die Unschärfe, die wir den
Sozialwissenschaften vorgeworfen haben: jeder Begriff einmal genau gesetzt, danach durchgehalten.
Lebendes Dokument — wächst, während die Kapitel wachsen. Das **Forschungs-Vokabular** (Probanz,
Lingdeem, Achsen, Cluster) bleibt bewusst draußen; es lebt in der
...
Drei Wörter, drei verschiedene Ämter — nie synonym zu verwenden.

- **Welt** — das, was *ist*, auch ohne Beobachter. Aber nur als **Widerstand** registrierbar, nie
  beschreibbar (jede Beschreibung konstruiert schon). Grenzbegriff: bejaht (kein Idealismus),
  unzugänglich. Eine Wirkung heißt *welt-gekoppelt*, wenn sie den Wegfall jeder menschlichen
  Übereinkunft überlebt — der Apfel nährt, ob jemand zustimmt oder nicht.
- **Wirklichkeit** — das *Wirkende*, das Für-uns-in-Kraft-Tretende (von *wirken*; Berger/Luckmann
  dt.: „Die gesellschaftliche Konstruktion der **Wirklichkeit**"). *Hier* leben wir; sie ist
  konstruiert und gehalten. *Erzähl-gekoppelt*, wenn ihre Wirkung allein aus Übereinkunft und
  Durchsetzung stammt — Geld, Grenze, Gesetz.
- **Realität** — *die Illusion*, die Dinge mit Worten erfassen zu können, wie sie sind: die
  **Karte für die Landschaft** halten (Korzybski). Übereinstimmung (*match*) statt Passung
  (*fit*). Im Buch **nur kritisch** verwendet — der Name des Reflexes, den das Buch entzaubert.
  Disziplin: nie beiläufig-positiv („in der Realität …").
...
Probanz, Lingdeem, Referent-Leiter, die sechs Achsen, die 9-Stufen-Leiter, Cluster — das
Forschungs-Vokabular gehört nicht in den Buchtext, sondern in die Probanz-Werkstatt. Einzelne
*Befunde* daraus kommen als Geschichten; die *Apparatur* bleibt draußen.

---

*Regel: Begriffe einmal genau setzen, dann durchhalten. Wer hier einen Eintrag ändert, prüft die
Kapitel, die ihn verwenden.*
